    ...
    <div className="min-h-screen pt-24 pb-20 bg-slate-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10 animate-fade-in-up delay-100">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-5 sm:p-6 flex flex-col justify-between h-full">
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-inner border border-slate-200 group cursor-pointer mb-4" onClick={onLaunch}>
               <ImageWithFallback
            ...
            <div className="flex flex-wrap justify-between items-center gap-2">
               {[
                ...
                <div key={i} className="flex items-center gap-1.5 text-slate-500 bg-slate-50 sm:bg-transparent px-2 py-1 sm:p-0 rounded-lg sm:rounded-none">
                   <f.icon size={14} className="shrink-0" />
                   <span className="text-[10px] sm:text-xs font-bold whitespace-nowrap">{f.title}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* 2. Video Trailer */}
          <div className="bg-slate-900 rounded-3xl shadow-xl shadow-slate-900/20 p-5 sm:p-6 flex flex-col h-full text-white relative overflow-hidden justify-between min-h-[300px]">
             ...
             <a 
               ...
               className="relative w-full aspect-video bg-black/50 rounded-xl overflow-hidden border border-white/10 group cursor-pointer shadow-lg z-10 block mb-2"
             >
                 <img 
          ...
          {/* 3. Project Impact Stats */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-6 sm:p-8 text-white shadow-lg flex flex-col justify-center h-full min-h-[160px]">
             <div className="flex flex-col sm:flex-row items-center sm:justify-between h-full gap-6 sm:gap-0">
                ...
                <div className="grid grid-cols-3 gap-4 sm:gap-6 text-center w-full sm:w-auto">
                    {[
                      ...
                      <div key={i}>
                        <div className="text-xl sm:text-2xl lg:text-3xl font-black">{s.m}</div>
                        <p className="text-blue-100 text-[9px] sm:text-[10px] uppercase font-bold tracking-wide">{s.d}</p>
                      </div>
                    ))}
                 </div>
             </div>
          ...
          {/* 4. Project Poster (Uses root-relative path) */}
